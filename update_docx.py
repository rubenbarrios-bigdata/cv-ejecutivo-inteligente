...
paragraphs.append(make_p("• <b>Tecnicatura Superior en Ciencia de Datos e Inteligencia Artificial</b> — En curso (Primer Año) — Instituto de Formación Técnica Superior | Buenos Aires, Argentina", size=18, bullet=True, space_after=20))
paragraphs.append(make_p("• <b>Business Intelligence (BI Consulting)</b> — En curso (Ruta formativa oficial hacia Analista de Datos)", size=18, bullet=True, space_after=20))
