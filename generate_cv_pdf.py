...
def build_pdf_es(filename="CV_Ruben_Barrios_Analista_De_Datos.pdf"):
    ...
    story.append(hr())
    story.append(Paragraph("<b>Analista de Datos</b> con experiencia demostrada en análisis de métricas de fraude, logística y e-commerce, y más de 15 años de sólida trayectoria previa en el sector bancario y financiero internacional. Con enfoque resolutivo orientado a transformar requerimientos de negocio en soluciones analíticas de alto impacto mediante el diseño de dashboards en <b>Excel, Power BI y Data Studio</b>, consultas <b>SQL (MySQL, PostgreSQL)</b>, automatización con <b>Python (pandas)</b> y analítica digital de productos con <b>GTM, GA4, Supabase y Looker Studio</b>.", styles["Body"]))
...
def build_pdf_en(filename="CV_Ruben_Barrios_Data_Analyst.pdf"):
    ...
    story.append(hr())
    story.append(Paragraph("<b>Data Analyst</b> with demonstrated experience analyzing fraud metrics, logistics, and e-commerce operations, backed by over 15 years of solid prior experience in the international banking and financial sector. Solutions-oriented with a proven track record of transforming business requirements into high-impact analytical solutions through dashboard design in <b>Excel, Power BI, and Data Studio</b>, <b>SQL queries (MySQL, PostgreSQL)</b>, automation with <b>Python (pandas)</b>, and digital product analytics with <b>GTM, GA4, Supabase, and Looker Studio</b>.", styles["Body"]))
    story.append(Spacer(1, 2))
