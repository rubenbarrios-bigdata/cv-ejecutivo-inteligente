...
def build_pdf_es(filename="CV_Ruben_Barrios_Analista_De_Datos.pdf"):
    ...
    story.append(hr())
    t_p3 = Table([[Paragraph("Sector Bancario — Operaciones Internacionales & Finanzas Corporativas | Caracas, Venezuela", styles["JobTitleLeft"]), Paragraph("2002 – 2017", styles["JobDateRight"])]], colWidths=[usable_width - 110, 110])
    ...
    story.append(t_p3)
    story.append(Paragraph("Especialista de Comercio Exterior (BFC Banco Fondo Común) | Analista de Operaciones Internacionales (Banco Exterior) | Analista de Compras & Representante de Ventas (Venezolano de Crédito S.A.)", styles["JobRole"]))
...
def build_pdf_en(filename="CV_Ruben_Barrios_Data_Analyst.pdf"):
    ...
    story.append(hr())
    t_p3 = Table([[Paragraph("Banking Sector — International Operations & Corporate Finance | Caracas, Venezuela", styles["JobTitleLeft"]), Paragraph("2002 – 2017", styles["JobDateRight"])]], colWidths=[usable_width - 110, 110])
    t_p3.setStyle(TableStyle([('VALIGN', (0,0), (-1,-1), 'MIDDLE'), ('LEFTPADDING', (0,0), (-1,-1), 0), ('RIGHTPADDING', (0,0), (-1,-1), 0), ('TOPPADDING', (0,0), (-1,-1), 0), ('BOTTOMPADDING', (0,0), (-1,-1), 0)]))
    story.append(t_p3)
    story.append(Paragraph("Foreign Trade Specialist (BFC Banco Fondo Común) | International Operations Analyst (Banco Exterior) | Procurement Analyst & Sales Representative (Venezolano de Crédito S.A.)", styles["JobRole"]))
